        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="card-title fw-semibold">Tambah Jenis Kas BCA</h3>
                </div>
                @if (session('success'))
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('bca_cashflows.type.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <form action="{{ route('bca_cashflows.type.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <form action="{{ route('bca_cashflows.type.destroy', $cashType->id) }}"
                                    ...
                                    <a href="{{ route('bca_cashflows.type.edit', $cashType->id) }}"
